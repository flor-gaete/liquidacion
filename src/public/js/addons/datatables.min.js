!(function (e) {
  ...
  function vt(t, a, r, n) {
    ...
    if (
      (a &&
        (i = e.map(t[a].slice().reverse(), function (e, a) {
    ...
    n = function (t) {
      (this.$ = function (e, t) {
        ...
        (this.fnOpen = function (e, t, a) {
          return this.api(!0).row(e).child(t, a).Mostrar().child()[0];
        }),
      ...
      return (
        this.each(function () {
          ...
          if (
            (X(w, l.aoColumnDefs, H, function (e, t) {
              O(w, e, t);
            }),
            A.length)
          ) {
    ...
    (l.register = o = function (t, a) {
      if (e.isArray(t))
        ...
        for (i = 0, o = s.length; o > i; i++) {
          ...
          var h = d(u, f);
          h ||
            ((h = { name: f, val: {}, methodExt: [], propExt: [] }), u.push(h)),
  ...
  o("rows()", function (t, a) {
    ...
    s("rows().remove()", "row().remove()", function () {
      var e = this;
      return (
        this.iterator("row", function (t, a, n) {
          var o,
            s,
            u,
            f,
  ...
  o(Ht, function (e, t) {
    ...
    o([Nt + ".Mostrar()", Ht + ".Mostrar()"], function (e) {
  ...
  o("columns()", function (t, a) {
    ...
    s("columns().visible()", "column().visible()", function (e, t) {
      ...
      return (
        e !== r &&
          (this.iterator("column", function (a, r) {
  ...
  o("cells()", function (t, a, n) {
    ...
    (n.isDataTable = n.fnIsDataTable = function (t) {
      ...
      return t instanceof n.Api
        ? !0
        : (e.each(n.settings, function (t, n) {
  ...
  e.extend(Et, {
    ...
    e.extend(n.ext.type.detect, [
      ...
      function (e, t) {
        return v(e) || ("string" == typeof e && -1 !== e.indexOf("<"))
          ? "html"
          : null;
      },
    ]),
